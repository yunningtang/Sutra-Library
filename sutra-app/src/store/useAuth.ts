  ...
  syncToCloud: async () => {
    ...
    const payload = {
      ...
      settings: {
        ...
        showCounterRing: store.showCounterRing,
        showHomeStats: store.showHomeStats,
  ...
  syncFromCloud: async () => {
    ...
    useStore.setState({
      ...
      ...(settings && {
        ...
        showProgress: settings.showProgress !== undefined ? (settings.showProgress as boolean) : store.showProgress,
        showCounterRing: settings.showCounterRing !== undefined ? (settings.showCounterRing as boolean) : store.showCounterRing,
        showHomeStats: settings.showHomeStats !== undefined ? (settings.showHomeStats as boolean) : store.showHomeStats,
